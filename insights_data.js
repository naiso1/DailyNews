window.DAILY_INSIGHTS = [
    {
        ...
        ideas: {
            ...
            cn: [
                ...
                { id: 669, img: "images/idea_dummy.svg", title: "骨格樹脂化「軽量化インパネ・ドアトリム」", desc: "豊田合成の**骨格樹脂化技術**を**応用**し、**鉄製インパネ**を**高強度樹脂**で**置き換える**。EVの**フラットフロア**を活かし、**軽量化**と**デザイン性**を**両立**。**衝撃吸収**も**強化**され、**安全性**と**快適さ**を**向上**[cn628][cn630]。", imagePrompt: "" },
            ],
            in: [
                ...
                { id: 671, img: "images/idea_dummy.svg", title: "グリップ・センサ・統合・スマート・ステアリング", desc: "豊田合成の**グリップセンサ**をベースに、**HMI**機能と**タッチ操作**を統合。手放し検知機能と**多機能スイッチ**を備え、**安全**かつ**便利**な操作を実現。**運転中の**ストレスを軽減し、**エンタメ**機能を統合。インドの**複雑な交通状況**でも**安心感**と**楽しさ**を**提供**します。", imagePrompt: "" },
            ],
            us: [
                { id: 672, img: "images/idea_dummy.svg", title: "GlobalSafeSeat: グローバル品質保証×調和シート（衝突時でも作動が確実な調香安全シート）**、抗菌・消臭機能で車内を清潔に保ち、海外市場への参入障壁を低くする。", desc: "親世代のトロフィーカー志向[jus591]や、サプライヤーの無断変更によるリコール[jus592]の教訓を踏まえ、グローバル市場で信頼性を高める**衝突時調香安全シート**を開発。抗菌・消臭機能で車内を清潔に保ち、海外市場への参入障壁を低くする。特に中国EVメーカーとの提携[jus593]など、海外調達が広がる中、日本製の高品質内装で差別化し、現地市場での信頼を確立する。**うれしさ**は、衝突時でも安心感を得られ、車内が常に清潔で快適な環境を提供できる点。", imagePrompt: "" },
                { id: 673, img: "images/idea_dummy.svg", title: "MiniWireCharge EV: 小型ワイヤレス充電ホルダ×EVシフトノブ（業界比60%小型化を実現したスマートフォン向けワイヤレス充電ホルダをEVシフトノブに転用）**、EV車のシフトノブに統合し、EV6などの低迷[jus596]を解消。", desc: "豊田合成の**小型ワイヤレス充電ホルダ**をEVシフトノブに転用し、EV車のシフトノブに統合。業界比60%小型化を実現し、EV6などの低迷[jus596]を解消。特にEV9のようなEV車の需要回復を支援し、EVシフトノブにスマートフォンを無線充電する機能を統合。これにより、EV車の高級感と実用性を両立し、EV6などの低迷[jus596]を解消。**うれしさ**は、EVシフトノブにスマートフォンを無線充電でき、EV車の高級感と実用性を両立できる点。", imagePrompt: "" },
            ],
            eu: [
                { id: 674, img: "images/idea_dummy.svg", title: "CostOpti EU+：量産化×モジュール統合コンソール", desc: "EU市場の**EV**トレンド[eu566]と**コスト競争力**を重視。豊田合成の**EVプラットフォーム**[eu494]向け**モジュール設計**を徹底。部品共通化で**量産化**を実現し、**EV**バッテリー[eu572]や**AI**安全[eu571]に対応。コスト低下で**中古EV**[eu566]価格競争力も強化。ユーザーは**高機能**で**低価格**な**EV**内装を**喜ぶ**！", imagePrompt: "Cost-effective modular interior console for EV platform, mass production design, shared components, brushed aluminum and textured plastic materials, modern automotive cockpit, European market style, photorealistic rendering, high quality, clean lines, professional product visualization, cinematic lighting, 4K quality" },
                { id: 675, img: "images/idea_dummy.svg", title: "GlowSafe EU+：発光ミリ波レーダー透過コンソール", desc: "豊田合成**発光ミリ波レーダー透過エンブレム**[eu532]を**コンソール**へ拡大。ミリ波レーダー信号を**透過**しながら**イルミネーション**発光。EUの**AI**安全[eu571]と**HMI**進化[eu569]に対応。**EV**バッテリー[eu572]の**熱対策**[eu489]も統合。**プレミアム**な**光×触覚**体験[eu524]で、ユーザーは**安全で****スタイリッシュ**な**EV**内装を**喜ぶ**！", imagePrompt: "GlowSafe illuminated console with millimeter wave radar transparency, futuristic automotive interior design, European EV market style, glowing LED accents, brushed aluminum and premium leather materials, night driving scene, photorealistic 3D render, high detail, cinematic lighting, premium quality, professional product visualization, 4K quality" },
            ],
        }
    },
{
