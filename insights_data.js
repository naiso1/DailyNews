window.DAILY_INSIGHTS = [
    {
        ...
        analysis: {
            ...
            in: "インド市場では**プレミアム化**と**価格多様化**が同時進行する。メルセデス・ベンツとアウディの値上げ[in528]が高級内装需要を押し上げる一方、Hyundai i20[in526]とNissan Gravite[in532]はデザイン訴求で幅広い層を狙う。2026年末に5社がコンパクトSUVへ参入[in527]し内装差別化競争が激化。ルノー・ドゥスター[in529]のハイブリッド採用とHettich[in534]の工場新設が**サプライチェーン強化**を示す。高付加価値素材と価格帯に対応したモジュール内装が求められる。",
