...
assert(context.describeExteriorPublication(receipt, news).includes('当日掲載1件、直近7日からの補充1件'));
...
console.log('Exterior issue UI: IDs, original dates, supplement labels, legacy interior behavior PASS');
