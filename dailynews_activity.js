...
function injectActivityStyles() {
  ...
  style.textContent = `
    ...
    .engagement-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-items:stretch;gap:16px;width:100%;max-width:1400px;margin:0 auto 20px}.engagement-row>.activity-rail,.engagement-row>.ranking-wrapper{min-width:0;height:100%;margin:0;box-sizing:border-box}.engagement-row .ranking-section{display:flex;height:100%;padding:17px 18px;flex-direction:column;border-radius:18px;box-sizing:border-box}.engagement-row .activity-grid{grid-template-columns:1fr}.engagement-row .ranking-header{align-items:flex-end;margin-bottom:12px}.engagement-row .ranking-heading{display:grid;gap:2px}.engagement-row .ranking-kicker{color:#7df1c2;font-size:9px;font-weight:800;letter-spacing:.14em}.engagement-row .ranking-title{margin:0;font-size:17px}.engagement-row .ranking-list{gap:9px}.engagement-row .ranking-item{grid-template-columns:minmax(0,1fr) auto;min-height:86px;padding:9px;gap:9px;border-radius:13px;box-sizing:border-box}.engagement-row .ranking-left{align-items:center;gap:9px}.engagement-row .ranking-title-text{font-size:11px;line-height:1.45}.engagement-row .ranking-meta{flex-wrap:nowrap;gap:6px;font-size:9px;white-space:nowrap}.engagement-row .ranking-stat{font-size:9px}.engagement-row .ranking-meta .action-btn{width:32px;height:30px;justify-content:center;padding:3px 5px;font-size:10px;gap:3px}.engagement-row .ranking-meta .remove-news-btn{width:30px}.engagement-row .ranking-thumb{width:68px;height:68px;flex-basis:68px;border-radius:9px}.engagement-row .ranking-rank{width:24px;font-size:14px}.engagement-row .ranking-footer{display:flex;justify-content:center;margin-top:auto;padding-top:11px}.engagement-row .ranking-footer .ranking-toggle{font-size:10px}.engagement-row .ranking-body{flex:0 0 auto}
    .activity-rail{display:flex;max-width:1400px;margin:0 auto 20px;padding:17px 18px;flex-direction:column;border:1px solid rgba(255,255,255,.08);border-radius:18px;background:rgba(16,22,35,.9);box-shadow:0 15px 40px rgba(0,0,0,.25)}
    ...
    @media(max-width:1280px){.engagement-row{grid-template-columns:1fr;margin-inline:10px}.engagement-row>.activity-rail,.engagement-row>.ranking-wrapper{margin:0}.engagement-row .ranking-item{grid-template-columns:minmax(0,1fr) auto}}
    @media(max-width:680px){.engagement-row .ranking-item{grid-template-columns:minmax(0,1fr)}.engagement-row .ranking-meta{padding-left:33px;flex-wrap:wrap;white-space:normal}}
