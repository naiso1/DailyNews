...
function injectActivityStyles() {
  ...
  style.textContent = `
    ...
    .engagement-row{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));align-items:stretch;gap:16px;max-width:1400px;margin:0 auto 20px}.engagement-row>.activity-rail,.engagement-row>.ranking-wrapper{min-width:0;height:100%;margin:0;box-sizing:border-box}.engagement-row .ranking-section{height:100%;box-sizing:border-box}.engagement-row .activity-grid{grid-template-columns:1fr}.engagement-row .ranking-title{font-size:17px}.engagement-row .ranking-item{grid-template-columns:minmax(0,1fr) auto;min-height:108px;gap:10px}.engagement-row .ranking-left{align-items:center;gap:9px}.engagement-row .ranking-title-text{font-size:11px;line-height:1.45}.engagement-row .ranking-meta{flex-wrap:nowrap;gap:6px;font-size:9px;white-space:nowrap}.engagement-row .ranking-stat{font-size:9px}.engagement-row .ranking-meta .action-btn{width:32px;height:30px;justify-content:center;padding:3px 5px;font-size:10px;gap:3px}.engagement-row .ranking-meta .remove-news-btn{width:30px}.engagement-row .ranking-thumb{width:52px;height:52px;flex-basis:52px}.engagement-row .ranking-rank{width:24px;font-size:14px}
