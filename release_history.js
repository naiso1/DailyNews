...
window.DAILYNEWS_RELEASE_HISTORY = [
  {
    date: "2026-09-16",
    title: "内装・外装の共通ログインと配信選択、外装トレンド・exaBase画像",
    items: [
      "内装版のメールアドレスとパスワードで外装版も利用できます。マイページで内装だけ・外装だけ・両方・受信なしを選べます。これまでの購読設定と、版ごとのお気に入り・コメント・アクセス集計は引き継ぎます。",
      "外装ニュースにデザイン・市場・規制・材料・競合の情報を加え、「製品・技術」と「トレンド・マーケット」で絞り込めるようにしました。本文で関連性を確認し、条件に合う記事を選びます。",
      "外装の企画画像をexaBaseで生成する連携を追加しました。最新日の最大4案から開始し、画面には「AI生成イメージ」と表示します。画像を作れない場合も文章は更新します。",
    ],
  },
  {
    date: "2026-09-15",
  ...
  },
  {
    ...
    items: [
      ...
      "文章生成と内装画像の判定に使うローカルAIをQwen3.8-27Bへ変更しました。アイデアの画像生成は引き続きGeminiを利用します。",
      "9月15日の初回定期処理は0:00に起動し、1:23に公開まで完了しました。9月14日付のニュースを5地域各10件・計50件、各地域の考察とアイデア画像10枚を反映しています。",
      "旧PCの自動実行を停止し、新PCのみで処理するチェックも追加しました。二重実行を防ぎながら、平日の定期更新と既存のメール連携を継続します。",
    ],
  },
  {
    date: "2026-09-14",
    title: "車載画面の記事の日本語化と要約チェックを改善",
    items: [
      "日本語化で停止していた記事を原文と照合して修正し、収集済みデータから更新を再開しました。各国10件を維持し、日本語化前の公開を防ぐチェックも継続します。",
      "画面と物理ボタン・空調操作の記述を内装の具体情報として判定し、適切な要約を情報不足と誤判定する問題を改善しました。",
      "The Truth About Carsでは関連記事・読者コメントを本文に混ぜないよう取得位置を修正し、再要約でも本文後半の情報を参照できるようにしました。",
      "公開処理から要約チェックを読み込む際の参照先を修正し、実際の起動方法に合わせたテストを追加しました。",
    ],
  },
  {
    date: "2026-09-11",
    title: "インド通貨の桁違いと円換算の表示漏れを修正",
    items: [
      "本日分のインド3記事で、Lakh（10万）の倍率が欠落・誤変換していた価格を原文と照合して修正しました。",
      "要約後と公開前に原文のLakh・Croreを照合し、金額を一意に確認できる単位の誤りを自動補正します。原文も引き継ぎ、収集を省略した再開時にも確認します。",
      "「31万3千ドル」のように万・千・億を組み合わせた金額の円換算に対応し、us1620でも表示されるようにしました。",
    ],
  },
  {
    date: "2026-09-11",
    title: "日本語化で停止した更新の復旧と再開処理を改善",
    items: [
      "日本語化に失敗した3記事を原文と照合し、内装の具体情報と仕様の注意点を含めた日本語へ修正しました。",
      "原文照合で一般語や関連記事が混ざる問題を修正し、ブランド名の日本語表記と要約の再試行条件を改善しました。日本語化が未完了のまま公開しないチェックは維持します。",
      "対象日を確認した収集済みデータから、ニュース収集を繰り返さず後続処理を再開できるようにしました。",
    ],
  },
  {
    date: "2026-09-10",
    title: "記事を読むリンクに原文の該当箇所を自動設定",
    items: [
      "新規掲載時に原文の本文と要約のキーワード・固有名詞を照合し、一致を確認できた箇所へのハイライト指定を自動で付けるようにしました。ボタンの表示と操作は従来どおりです。",
      "本日公開分も原文を確認して適用しました。本文を取得できない記事や該当箇所を確認できない記事は、通常のリンクを維持します。リンク先サイトの動作によってはハイライトが表示されない場合があります。",
      "追加のAI呼び出しや画像生成は行わず、確認結果は保存して再利用します。",
    ],
  },
  {
    date: "2026-09-10",
    title: "eu1576・eu1573の日本語化と公開前チェックを修正",
    items: [
      "英語のまま掲載されていた2記事のタイトル・要約を、原文で確認した内容に基づく日本語へ修正しました。",
      "英語見出しの一般語を固有名詞と誤認する判定を修正し、ブランド名の一般的な日本語表記も原文照合で認めるようにしました。",
      "本文の取得位置と再試行処理を見直し、日本語化が完了していないニュースは公開前に検出して更新を停止するようにしました。",
    ],
  },
  {
    date: "2026-09-08",
  ...
  },
  {
    ...
    items: [
      ...
      "cn1585の途切れたタイトルと短すぎる要約を修正し、原文の可動式コンソール・冷蔵庫・画面・空間レイアウトなどを反映しました。",
      "見出しを文字数だけで切らず、要約の短縮で内装の具体情報が抜け落ちていないか確認する処理を追加しました。",
    ],
  },
  {
    date: "2026-09-08",
    title: "原文確認を記事ボタンへ統合・コメントの読みやすさを改善",
    items: [
      "jp1780の原文確認リンクを「記事を読む」に統合。対応ブラウザでは原文の該当箇所へ移動します。",
      "みんなの動きと人気ニュースランキングの見出し・カード・下部ボタンの寸法を統一しました。",
      "みんなの動きのコメント文字を拡大し、長いコメントも省略せず読めるように調整しました。",
    ],
  },
  {
    date: "2026-09-08",
    title: "外貨の円換算と原文確認リンクを追加",
    items: [
      "ニュース内の外貨金額を円換算で表示。金額を押すと為替レート・基準日・計算結果を確認できます。",
      "jp1780の後席装備への批評を、採用済みの特徴と逆の意味で要約していた箇所を修正しました。",
      "jp1780に原文の該当箇所を開くリンクを追加。次回の要約から筆者の要望・否定・比較対象を保持する条件を強化しました。",
    ],
  },
  {
    date: "2026-09-07",
  ...
  },
  {
    ...
    items: [
      "みんなの動きと人気ニュースランキングの外枠・内側余白・カード位置を左右対称に調整",
      "過去の動きを見るボタンとランキングの開閉ボタンを、両パネル最下部の同じ位置へ配置",
    ],
  },
  {
    date: "2026-09-04",
    title: "管理者向け画像URL編集を追加",
    items: [
      "管理者のニュースカードに画像URL編集ボタンを追加",
      "変更した画像を全ユーザーのニュース・ランキング・みんなの動き・マイページへ反映",
      "画像URLをSQLiteへ保存し、必要に応じて元画像へ戻せるように対応",
    ],
  },
  {
    date: "2026-09-04",
    title: "トップ画面の左右バランスを調整",
    items: [
      "みんなの動きと人気ニュースランキングを同じ幅・高さ・見出しサイズに統一",
      "人気ニュースのタイトル・地域・日付・反応ボタンを同じ行にまとめ、カードをコンパクト化",
    ],
  },
  {
    date: "2026-09-04",
    title: "アクセス分析とニュース整理機能を改善",
    items: [
      "日別アクセス分析を、マイページと同様に画面前面で確認できる表示へ変更",
      "みんなの動きと人気ニュースランキングを横並びにし、情報を比較しやすく改善",
      "関連なしボタンをゴミ箱へ変更し、理由付きで全ユーザーの一覧から記事を削除できる機能を追加",
      "削除記事をNew件数・ランキング・みんなの動きへ連動し、管理画面から復元できるように対応",
    ],
  },
  {
    date: "2026-09-04",
